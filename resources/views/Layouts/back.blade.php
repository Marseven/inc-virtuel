...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Cyberschool Entrepreunariat - Admin</title>
    ...
    <!-- font icons-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/Back/fonts/icomoon.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/Back/fonts/flag-icon-css/css/flag-icon.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/Back/css/core/menu/menu-types/vertical-overlay-menu.css') }}">
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
    ...
    <footer class="footer footer-static footer-light navbar-border">
      Développer par <i class="fa fa-love"></i><a href="https://bootstrapthemes.co">CyberSchool Entreprenariat</a>
    </footer>

    <!-- BEGIN VENDOR JS-->
    <script src="{{ asset('/Back/js/core/libraries/jquery.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/Back/vendors/js/ui/tether.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/Back/js/core/libraries/bootstrap.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/Back/vendors/js/ui/perfect-scrollbar.jquery.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/Back/vendors/js/ui/unison.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/Back/vendors/js/ui/blockUI.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/Back/vendors/js/ui/jquery.matchHeight-min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/Back/vendors/js/ui/screenfull.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/Back/vendors/js/extensions/pace.min.js') }}" type="text/javascript"></script>
    <!-- BEGIN VENDOR JS-->
