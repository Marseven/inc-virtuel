...
<head>
  <meta charset="utf-8">
  <title>CyberShool-Entrepreneuriat</title>
  ...
  <link href="{{ asset('/Front/css/jslider.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/revslider/settings.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/jquery.fancybox.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/animate.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/video-js.min.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/Front/css/morris.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/royalslider/royalslider.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/royalslider/skins/minimal-white/rs-minimal-white.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/layerslider/css/layerslider.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/ladda.min.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/datepicker.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/jquery.scrollbar.css') }}" rel="stylesheet">

  <!-- Theme CSS -->
  <link href="{{ asset('/Front/css/style.css') }}" rel="stylesheet">
  
  <!-- Custom CSS -->
  <link href="{{ asset('/Front/css/customizer/pages.css') }}" rel="stylesheet">
  <link href="{{ asset('/Front/css/customizer/home-pages-customizer.css') }}" rel="stylesheet">

  <!-- IE Styles-->
  <link href="{{ asset('/Front/css/ie/ie.css') }}" rel="stylesheet">
			  ...
			  <div class="navbar navbar-inverse top-navbar top-navbar-right" role="navigation">
				...
				<nav class="collapse collapsing navbar-collapse">
				  <ul class="nav navbar-nav navbar-right">
					<li><a href="shop-account.html">Mon Compte</a></li>
					<li><a href="contact.html">Nous contacter</a></li>
					<li><a href="#"></a></li>
					<li><a href="shop-login.html">Espace client <i class="fa fa-lock after"></i></a></li>
				  </ul>
				</nav>
			  </div>
			</div>
...
<!----*************FIN ENTETE BLEU*************---->
	...
	<header class="header header-two">
	  <div class="header-wrapper">
		<div class="container">
		  <div class="row">
			<div class="col-xs-7 col-md-2 col-lg-2 logo-box">
			  <div class="logo">
					<a href="index.html">
						<img src="{{ asset('/Front/img/logo.png') }}" class="logo-img" alt="">
					</a>
			  </div>
			</div><!-- .logo-box -->
				  ...
				  <div class="navbar navbar-default" role="navigation">
					...
					<nav class="collapse collapsing navbar-collapse">
					  <ul class="nav navbar-nav navbar-center">
						  ...
						  <ul class="sub">
							<li class="sub-wrapper">
							  <div class="sub-list">
								<div class="box closed">
								  ...
								  <ul>
									...
									<li><a href="#">Pourquoi sommes-nous différents des autres?</a></li>
									<li><a href="#">Savant Host (Mac Mini)<span class="item-new bg-warning">Wow</span></a></li>
								  </ul>
								</div><!-- .box -->
								
								<div class="box closed">
								  <h6 class="title">LES INCUBATEURS</h6>
								  <ul>
								...
								<div class="box closed">
								  <h6 class="title">LE CROWD FUNDING A CYBERSCHOOL</h6>
								  <ul>
								...
								<div class="box closed">
								  <h6 class="title">CLIENTS &amp; PARTENAIRES</h6>
								  <ul>
							  ...
							  <div class="promo-block text-center">
								<a href="#">
								  <img src="img/logo.png" class="replace-2x" width="253" height="457" alt="">
								</a>
							  </div><!-- .promo-block -->
							</li>
						  </ul><!-- .sub -->
						  ...
						  <ul class="sub">
							<li class="sub-wrapper">
							  <div class="sub-list">
								...
								<div class="box closed">
								  <h6 class="title">CREATION DES APPLICATIONS ET &amp; SITES WEB</h6>
								  <ul>
								...
								<div class="box closed">
								  <h6 class="title">CROWD FUNDING</h6>
								  <ul>
									<li><a href="#">Video Tiling<span class="item-new">New</span></a></li>
									<li><a href="#">On-Screen Display</a></li>
									<li><a href="#">Digital Messaging</a></li>
							  ...
							  <div class="promo-block text-center">
								<a href="#">
								  <img src="content/img/slider/rs-slider3-pig.png" class="replace-2x" width="253" height="457" alt="">
								</a>
							  </div><!-- .promo-block -->
							</li>
						  </ul><!-- .sub -->
						...
						<li class="parent">
						  <a href="index.html">NOS START-UP</a>
						</li>
    ...
    <div class="container">
      <div class="row sidebar">
		...
		<aside class="col-xs-12 col-sm-6 col-md-3 widget newsletter">
		  ...
		  <div>
			<p>Inscrivez-vous à nos newsletter</p>
			<div class="clearfix"></div>
...
<script src="{{ asset('/Front/js/price-regulator/jshashtable-2.1_src.js') }}"></script>
<script src="{{ asset('/Front/js/price-regulator/jquery.numberformatter-1.2.3.js') }}"></script>
<script src="{{ asset('/Front/js/price-regulator/tmpl.js') }}"></script>
<script src="{{ asset('/Front/js/price-regulator/jquery.dependClass-0.1.js') }}"></script>
<script src="{{ asset('/Front/js/price-regulator/draggable-0.1.js') }}"></script>
<script src="{{ asset('/Front/js/price-regulator/jquery.slider.js') }}"></script>
<script src="{{ asset('/Front/js/jquery.carouFredSel-6.2.1-packed.js') }}"></script>
<script src="{{ asset('/Front/js/jquery.touchwipe.min.js') }}"></script>
...
<script src="{{ asset('/Front/js/jquery.sparkline.min.js') }}"></script>
...
<script src="{{ asset('/Front/js/jquery.selectBox.min.js') }}"></script>
<script src="{{ asset('/Front/js/jquery.royalslider.min.js') }}"></script>
<script src="{{ asset('/Front/js/jquery.tubular.1.0.js') }}"></script>
<script src="{{ asset('/Front/js/SmoothScroll.js') }}"></script>
<script src="{{ asset('/Front/js/country.js') }}"></script>
<script src="{{ asset('/Front/js/spin.min.js') }}"></script>
<script src="{{ asset('/Front/js/ladda.min.js') }}"></script>
<script src="{{ asset('/Front/js/masonry.pkgd.min.js') }}"></script>
<script src="{{ asset('/Front/js/morris.min.js') }}"></script>
<script src="{{ asset('/Front/js/raphael.min.js') }}"></script>
<script src="{{ asset('/Front/js/video.js') }}"></script>
<script src="{{ asset('/Front/js/pixastic.custom.js') }}"></script>
<script src="{{ asset('/Front/js/livicons-1.4.min.js') }}"></script>
<script src="{{ asset('/Front/js/layerslider/greensock.js') }}"></script>
<script src="{{ asset('/Front/js/layerslider/layerslider.transitions.js') }}"></script>
<script src="{{ asset('/Front/js/layerslider/layerslider.kreaturamedia.jquery.js') }}"></script>
...
<script src="{{ asset('/Front/js/jplayer/jquery.jplayer.min.js') }}"></script>
<script src="{{ asset('/Front/js/jplayer/jplayer.playlist.min.js') }}"></script>
